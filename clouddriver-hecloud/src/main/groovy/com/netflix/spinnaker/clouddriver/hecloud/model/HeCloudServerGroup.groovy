...
class HeCloudServerGroup implements ServerGroup, HeCloudBasicResource {
  ...
  @Override
  Long getCreatedTime() {
    def dateTime = HeCloudElasticCloudServerClient.ConvertIsoDateTime(asg.createdTime as String)
