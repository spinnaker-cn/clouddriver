package com.netflix.spinnaker.clouddriver.ctyun.cache
...
class Keys implements KeyParser {
  ...
  static Map<String, String> parse(String key) {
    ...
    if (parts.length < 2 || parts[0] != CtyunCloudProvider.ID) {
      return null
    }
  ...
  static String getApplicationKey(String application) {
    "$CtyunCloudProvider.ID:$Namespace.APPLICATIONS:${application.toLowerCase()}"
  }

  static String getClusterKey(String clusterName, String application, String account) {
    "$CtyunCloudProvider.ID:$Namespace.CLUSTERS:$account:${application?.toLowerCase()}:$clusterName"
  }
  ...
  static String getServerGroupKey(String cluster, String serverGroupName, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.SERVER_GROUPS:$account:$region:$cluster:$serverGroupName"
  }

  static String getInstanceKey(String instanceId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.INSTANCES:$account:$region:$instanceId"
  }

  static String getImageKey(String imageId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.IMAGES:$account:$region:$imageId"
  }

  static String getNamedImageKey(String imageName, String account) {
    "$CtyunCloudProvider.ID:$Namespace.NAMED_IMAGES:$account:$imageName"
  }

  static String getKeyPairKey(String keyId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.KEY_PAIRS:$account:$region:$keyId"
  }

  static String getZonesKey(String keyId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.ZONES:$account:$region:$keyId"
  }

  static String getInstanceTypeKey(String account, String region, String instanceType) {
    "$CtyunCloudProvider.ID:$Namespace.INSTANCE_TYPES:$account:$region:$instanceType"
  }

  static String getLoadBalancerKey(String loadBalancerId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.LOAD_BALANCERS:$account:$region:$loadBalancerId"
  }

  static String getSecurityGroupKey(String securityGroupId, String securityGroupName, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.SECURITY_GROUPS:$securityGroupName:$account:$region:$securityGroupId"
  }

  static String getNetworkKey(String networkId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.NETWORKS:$account:$region:$networkId"
  }

  static String getSubnetKey(String subnetId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.SUBNETS:$account:$region:$subnetId"
  }
  ...
  static String getTargetHealthKey(String loadBalancerId, String listenerId, String locationId, String instanceId, String account, String region) {
    "$CtyunCloudProvider.ID:$Namespace.HEALTH_CHECKS:$account:$region:$loadBalancerId:$listenerId:$locationId:$instanceId"
  }
}
