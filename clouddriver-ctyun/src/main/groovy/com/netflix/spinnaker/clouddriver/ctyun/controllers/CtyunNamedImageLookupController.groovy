...
@Slf4j
@RestController
@RequestMapping("/ctyun/images")
class CtyunNamedImageLookupController {
  ...
  List<NamedImage> getByImgId(@PathVariable String account, @PathVariable String region, @PathVariable String imageId, HttpServletRequest request) {
    ...
    render(null, [cache], null, region, request)
  }
