...
@AutoClone
@Canonical
class HuaweiCloudDeployDescription extends AbstractHuaweiCloudCredentialsDescription implements DeployDescription {
  /*
  common
   */
  String application
  ...
  String healthAuditMethod
  Integer healthPeriodicTime
